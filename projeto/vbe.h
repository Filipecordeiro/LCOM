...
#define RETURN_VBE_CONTROL	0x4F00
...
typedef struct {
  ...
  phys_bytes OemSoftwareRev;		/**< @brief Pointer to Vendor Name String */
  phys_bytes OemVendorNamePtr;		/**< @brief Pointer to Product Name String */
  phys_bytes OemProductNamePtr; 	/**< @brief Pointer to Product Revision String */
  uint8_t Reserved1[222];	/**< @brief Reserved for VBE implementation scratch */
  uint8_t Reserved2[256];	/**< @brief Data Area for OEM Strings */
} __attribute__((packed)) vbe_ctr_info_t;

/** @} end of vbe_ctr_info_t*/
